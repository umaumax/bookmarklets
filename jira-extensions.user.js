...
(async function() {
    ...
    // backlog window
    Array.from(document.querySelectorAll('.ghx-plan-extra-fields.ghx-plan-extra-fields-1.ghx-row')).forEach((e) => e.style.display = "none")
    // active sprint window
    Array.from(document.querySelectorAll('.ghx-issue-content .ghx-extra-field-row')).forEach((e) => e.style.display = "none")

    // create elemnts of labels
